                ...
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-4 mx-auto">
                      ...
                      <div class="flex justyfy-between">
                        ...
                        <button onclick="location.href='{{ route('events.create') }}'" class="flex mb-4 ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">新規登録</button>
                      </div>
